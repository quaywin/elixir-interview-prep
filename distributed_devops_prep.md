...
## 🚀 Các bài tập thực hành Ngày 2 (exercises/)
*   **[05_rate_limiter]**: Giới hạn tần suất request (GenServer + Timer). -> [Bài tập](exercises/05_rate_limiter/rate_limiter_practice.exs) | [Giải thích](exercises/05_rate_limiter/rate_limiter_explain.md)
*   **[06_batch_processor]**: Gom nhóm dữ liệu theo lô (BatchProcessor + Timer Cancellation). -> [Bài tập](exercises/06_batch_processor/batcher_practice.exs) | [Giải thích](exercises/06_batch_processor/batcher_explain.md)
